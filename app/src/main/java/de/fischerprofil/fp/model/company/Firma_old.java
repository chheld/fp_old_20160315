...
public class Firma_old implements Parcelable {
    ...
    public static final Creator<Firma_old> CREATOR = new Creator<Firma_old>() {
        @Override
        public Firma_old createFromParcel(Parcel in) {
            return new Firma_old(in);
        }

        @Override
        public Firma_old[] newArray(int size) {
            return new Firma_old[size];
        }
    };
